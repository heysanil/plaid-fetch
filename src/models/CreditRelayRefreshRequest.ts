...
/**
 * Check if a given object implements the CreditRelayRefreshRequest interface.
 */
export function instanceOfCreditRelayRefreshRequest(value: object): boolean {
    if (!('relay_token' in value)) return false;
    if (!('report_type' in value)) return false;
    return true;
}

export function CreditRelayRefreshRequestFromJSON(json: any): CreditRelayRefreshRequest {
    return CreditRelayRefreshRequestFromJSONTyped(json, false);
}

export function CreditRelayRefreshRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreditRelayRefreshRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreditRelayRefreshRequestToJSON(value?: CreditRelayRefreshRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
