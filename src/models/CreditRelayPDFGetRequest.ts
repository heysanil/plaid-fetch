...
/**
 * Check if a given object implements the CreditRelayPDFGetRequest interface.
 */
export function instanceOfCreditRelayPDFGetRequest(value: object): boolean {
    if (!('relay_token' in value)) return false;
    if (!('report_type' in value)) return false;
    return true;
}

export function CreditRelayPDFGetRequestFromJSON(json: any): CreditRelayPDFGetRequest {
    return CreditRelayPDFGetRequestFromJSONTyped(json, false);
}

export function CreditRelayPDFGetRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreditRelayPDFGetRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreditRelayPDFGetRequestToJSON(value?: CreditRelayPDFGetRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
