...
/**
 * Check if a given object implements the ProductPermissionsRequiredAuthWebhook interface.
 */
export function instanceOfProductPermissionsRequiredAuthWebhook(value: object): boolean {
...
export function ProductPermissionsRequiredAuthWebhookFromJSON(json: any): ProductPermissionsRequiredAuthWebhook {
    return ProductPermissionsRequiredAuthWebhookFromJSONTyped(json, false);
}

export function ProductPermissionsRequiredAuthWebhookFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductPermissionsRequiredAuthWebhook {
    if (json == null) {
        return json;
    }
    return {
...
export function ProductPermissionsRequiredAuthWebhookToJSON(value?: ProductPermissionsRequiredAuthWebhook | null): any {
    if (value == null) {
        return value;
    }
    return {
