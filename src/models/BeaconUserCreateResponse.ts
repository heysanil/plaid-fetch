...
/**
 * Check if a given object implements the BeaconUserCreateResponse interface.
 */
export function instanceOfBeaconUserCreateResponse(value: object): boolean {
...
export function BeaconUserCreateResponseFromJSON(json: any): BeaconUserCreateResponse {
    return BeaconUserCreateResponseFromJSONTyped(json, false);
}

export function BeaconUserCreateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BeaconUserCreateResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function BeaconUserCreateResponseToJSON(value?: BeaconUserCreateResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
