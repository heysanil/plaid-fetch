...
/**
 * Check if a given object implements the ExternalPaymentScheduleGet interface.
 */
export function instanceOfExternalPaymentScheduleGet(value: object): boolean {
...
export function ExternalPaymentScheduleGetFromJSON(json: any): ExternalPaymentScheduleGet {
    return ExternalPaymentScheduleGetFromJSONTyped(json, false);
}

export function ExternalPaymentScheduleGetFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExternalPaymentScheduleGet {
    if (json == null) {
        return json;
    }
    return {
...
export function ExternalPaymentScheduleGetToJSON(value?: ExternalPaymentScheduleGet | null): any {
    if (value == null) {
        return value;
    }
    return {
