...
/**
 * Check if a given object implements the FallbackAuthMicrodepositAutoVerifiedWebhook interface.
 */
export function instanceOfFallbackAuthMicrodepositAutoVerifiedWebhook(value: object): boolean {
...
export function FallbackAuthMicrodepositAutoVerifiedWebhookFromJSON(json: any): FallbackAuthMicrodepositAutoVerifiedWebhook {
    return FallbackAuthMicrodepositAutoVerifiedWebhookFromJSONTyped(json, false);
}

export function FallbackAuthMicrodepositAutoVerifiedWebhookFromJSONTyped(json: any, ignoreDiscriminator: boolean): FallbackAuthMicrodepositAutoVerifiedWebhook {
    if (json == null) {
        return json;
    }
    return {
...
export function FallbackAuthMicrodepositAutoVerifiedWebhookToJSON(value?: FallbackAuthMicrodepositAutoVerifiedWebhook | null): any {
    if (value == null) {
        return value;
    }
    return {
