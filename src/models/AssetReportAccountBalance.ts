...
/**
 * Check if a given object implements the AssetReportAccountBalance interface.
 */
export function instanceOfAssetReportAccountBalance(value: object): boolean {
    if (!('available' in value)) return false;
    if (!('current' in value)) return false;
    if (!('limit' in value)) return false;
    if (!('margin_loan_amount' in value)) return false;
    if (!('iso_currency_code' in value)) return false;
    if (!('unofficial_currency_code' in value)) return false;
    return true;
}

export function AssetReportAccountBalanceFromJSON(json: any): AssetReportAccountBalance {
    return AssetReportAccountBalanceFromJSONTyped(json, false);
}

export function AssetReportAccountBalanceFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssetReportAccountBalance {
    if (json == null) {
        return json;
    }
    return {
        ...
        'limit': json['limit'],
        'margin_loan_amount': json['margin_loan_amount'],
...
export function AssetReportAccountBalanceToJSON(value?: AssetReportAccountBalance | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'limit': value['limit'],
        'margin_loan_amount': value['margin_loan_amount'],
