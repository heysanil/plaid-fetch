...
/**
 * Check if a given object implements the BeaconUserUpdateResponse interface.
 */
export function instanceOfBeaconUserUpdateResponse(value: object): boolean {
...
export function BeaconUserUpdateResponseFromJSON(json: any): BeaconUserUpdateResponse {
    return BeaconUserUpdateResponseFromJSONTyped(json, false);
}

export function BeaconUserUpdateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BeaconUserUpdateResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function BeaconUserUpdateResponseToJSON(value?: BeaconUserUpdateResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
