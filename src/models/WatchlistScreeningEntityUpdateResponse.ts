...
/**
 * Check if a given object implements the WatchlistScreeningEntityUpdateResponse interface.
 */
export function instanceOfWatchlistScreeningEntityUpdateResponse(value: object): boolean {
...
export function WatchlistScreeningEntityUpdateResponseFromJSON(json: any): WatchlistScreeningEntityUpdateResponse {
    return WatchlistScreeningEntityUpdateResponseFromJSONTyped(json, false);
}

export function WatchlistScreeningEntityUpdateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WatchlistScreeningEntityUpdateResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function WatchlistScreeningEntityUpdateResponseToJSON(value?: WatchlistScreeningEntityUpdateResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
