...
/**
 * Check if a given object implements the IdentityVerificationGetResponse interface.
 */
export function instanceOfIdentityVerificationGetResponse(value: object): boolean {
...
export function IdentityVerificationGetResponseFromJSON(json: any): IdentityVerificationGetResponse {
    return IdentityVerificationGetResponseFromJSONTyped(json, false);
}

export function IdentityVerificationGetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentityVerificationGetResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function IdentityVerificationGetResponseToJSON(value?: IdentityVerificationGetResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
