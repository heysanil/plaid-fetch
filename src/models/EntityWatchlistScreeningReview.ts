...
/**
 * Check if a given object implements the EntityWatchlistScreeningReview interface.
 */
export function instanceOfEntityWatchlistScreeningReview(value: object): boolean {
...
export function EntityWatchlistScreeningReviewFromJSON(json: any): EntityWatchlistScreeningReview {
    return EntityWatchlistScreeningReviewFromJSONTyped(json, false);
}

export function EntityWatchlistScreeningReviewFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityWatchlistScreeningReview {
    if (json == null) {
        return json;
    }
    return {
...
export function EntityWatchlistScreeningReviewToJSON(value?: EntityWatchlistScreeningReview | null): any {
    if (value == null) {
        return value;
    }
    return {
