...
/**
 * Check if a given object implements the HistoricalUpdateWebhook interface.
 */
export function instanceOfHistoricalUpdateWebhook(value: object): boolean {
...
export function HistoricalUpdateWebhookFromJSON(json: any): HistoricalUpdateWebhook {
    return HistoricalUpdateWebhookFromJSONTyped(json, false);
}

export function HistoricalUpdateWebhookFromJSONTyped(json: any, ignoreDiscriminator: boolean): HistoricalUpdateWebhook {
    if (json == null) {
        return json;
    }
    return {
...
export function HistoricalUpdateWebhookToJSON(value?: HistoricalUpdateWebhook | null): any {
    if (value == null) {
        return value;
    }
    return {
