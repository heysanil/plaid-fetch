...
/**
 * Check if a given object implements the EntityWatchlistScreening interface.
 */
export function instanceOfEntityWatchlistScreening(value: object): boolean {
...
export function EntityWatchlistScreeningFromJSON(json: any): EntityWatchlistScreening {
    return EntityWatchlistScreeningFromJSONTyped(json, false);
}

export function EntityWatchlistScreeningFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityWatchlistScreening {
    if (json == null) {
        return json;
    }
    return {
...
export function EntityWatchlistScreeningToJSON(value?: EntityWatchlistScreening | null): any {
    if (value == null) {
        return value;
    }
    return {
