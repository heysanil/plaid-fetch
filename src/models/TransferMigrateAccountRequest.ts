...
/**
 * Check if a given object implements the TransferMigrateAccountRequest interface.
 */
export function instanceOfTransferMigrateAccountRequest(value: object): boolean {
...
export function TransferMigrateAccountRequestFromJSON(json: any): TransferMigrateAccountRequest {
    return TransferMigrateAccountRequestFromJSONTyped(json, false);
}

export function TransferMigrateAccountRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransferMigrateAccountRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function TransferMigrateAccountRequestToJSON(value?: TransferMigrateAccountRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
