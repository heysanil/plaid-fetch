...
/**
 * Check if a given object implements the BeaconUserAddress interface.
 */
export function instanceOfBeaconUserAddress(value: object): boolean {
...
export function BeaconUserAddressFromJSON(json: any): BeaconUserAddress {
    return BeaconUserAddressFromJSONTyped(json, false);
}

export function BeaconUserAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): BeaconUserAddress {
    if (json == null) {
        return json;
    }
    return {
...
export function BeaconUserAddressToJSON(value?: BeaconUserAddress | null): any {
    if (value == null) {
        return value;
    }
    return {
