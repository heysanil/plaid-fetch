 ...
 * @export
 */
export const WalletTransactionGetResponseTypeEnum = {
...
export type WalletTransactionGetResponseTypeEnum = typeof WalletTransactionGetResponseTypeEnum[keyof typeof WalletTransactionGetResponseTypeEnum];


/**
 * Check if a given object implements the WalletTransactionGetResponse interface.
 */
export function instanceOfWalletTransactionGetResponse(value: object): boolean {
...
export function WalletTransactionGetResponseFromJSON(json: any): WalletTransactionGetResponse {
    return WalletTransactionGetResponseFromJSONTyped(json, false);
}

export function WalletTransactionGetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WalletTransactionGetResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function WalletTransactionGetResponseToJSON(value?: WalletTransactionGetResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
