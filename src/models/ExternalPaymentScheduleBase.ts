...
/**
 * Check if a given object implements the ExternalPaymentScheduleBase interface.
 */
export function instanceOfExternalPaymentScheduleBase(value: object): boolean {
    return true;
}

export function ExternalPaymentScheduleBaseFromJSON(json: any): ExternalPaymentScheduleBase {
    return ExternalPaymentScheduleBaseFromJSONTyped(json, false);
}

export function ExternalPaymentScheduleBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExternalPaymentScheduleBase {
    if (json == null) {
        return json;
    }
    return {
            ...
            ...json,
        'interval': json['interval'] == null ? undefined : PaymentScheduleIntervalFromJSON(json['interval']),
        'interval_execution_day': json['interval_execution_day'] == null ? undefined : json['interval_execution_day'],
...
export function ExternalPaymentScheduleBaseToJSON(value?: ExternalPaymentScheduleBase | null): any {
    if (value == null) {
        return value;
    }
    return {
