...
/**
 * Check if a given object implements the IdentityVerification interface.
 */
export function instanceOfIdentityVerification(value: object): boolean {
...
export function IdentityVerificationFromJSON(json: any): IdentityVerification {
    return IdentityVerificationFromJSONTyped(json, false);
}

export function IdentityVerificationFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentityVerification {
    if (json == null) {
        return json;
    }
    return {
...
export function IdentityVerificationToJSON(value?: IdentityVerification | null): any {
    if (value == null) {
        return value;
    }
    return {
