...
/**
 * Check if a given object implements the WatchlistScreeningEntityCreateResponse interface.
 */
export function instanceOfWatchlistScreeningEntityCreateResponse(value: object): boolean {
...
export function WatchlistScreeningEntityCreateResponseFromJSON(json: any): WatchlistScreeningEntityCreateResponse {
    return WatchlistScreeningEntityCreateResponseFromJSONTyped(json, false);
}

export function WatchlistScreeningEntityCreateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WatchlistScreeningEntityCreateResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function WatchlistScreeningEntityCreateResponseToJSON(value?: WatchlistScreeningEntityCreateResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
