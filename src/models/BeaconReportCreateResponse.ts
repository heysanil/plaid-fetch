...
/**
 * Check if a given object implements the BeaconReportCreateResponse interface.
 */
export function instanceOfBeaconReportCreateResponse(value: object): boolean {
...
export function BeaconReportCreateResponseFromJSON(json: any): BeaconReportCreateResponse {
    return BeaconReportCreateResponseFromJSONTyped(json, false);
}

export function BeaconReportCreateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BeaconReportCreateResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function BeaconReportCreateResponseToJSON(value?: BeaconReportCreateResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
