...
/**
 * Check if a given object implements the IdentityVerificationRetryResponse interface.
 */
export function instanceOfIdentityVerificationRetryResponse(value: object): boolean {
...
export function IdentityVerificationRetryResponseFromJSON(json: any): IdentityVerificationRetryResponse {
    return IdentityVerificationRetryResponseFromJSONTyped(json, false);
}

export function IdentityVerificationRetryResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentityVerificationRetryResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function IdentityVerificationRetryResponseToJSON(value?: IdentityVerificationRetryResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
