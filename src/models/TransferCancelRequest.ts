...
/**
 * Check if a given object implements the TransferCancelRequest interface.
 */
export function instanceOfTransferCancelRequest(value: object): boolean {
    if (!('transfer_id' in value)) return false;
    return true;
}

export function TransferCancelRequestFromJSON(json: any): TransferCancelRequest {
    return TransferCancelRequestFromJSONTyped(json, false);
}

export function TransferCancelRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransferCancelRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function TransferCancelRequestToJSON(value?: TransferCancelRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
