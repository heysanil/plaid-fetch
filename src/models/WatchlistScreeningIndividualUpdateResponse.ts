...
/**
 * Check if a given object implements the WatchlistScreeningIndividualUpdateResponse interface.
 */
export function instanceOfWatchlistScreeningIndividualUpdateResponse(value: object): boolean {
...
export function WatchlistScreeningIndividualUpdateResponseFromJSON(json: any): WatchlistScreeningIndividualUpdateResponse {
    return WatchlistScreeningIndividualUpdateResponseFromJSONTyped(json, false);
}

export function WatchlistScreeningIndividualUpdateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WatchlistScreeningIndividualUpdateResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function WatchlistScreeningIndividualUpdateResponseToJSON(value?: WatchlistScreeningIndividualUpdateResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
