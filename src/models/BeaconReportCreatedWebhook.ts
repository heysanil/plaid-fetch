...
/**
 * Check if a given object implements the BeaconReportCreatedWebhook interface.
 */
export function instanceOfBeaconReportCreatedWebhook(value: object): boolean {
...
export function BeaconReportCreatedWebhookFromJSON(json: any): BeaconReportCreatedWebhook {
    return BeaconReportCreatedWebhookFromJSONTyped(json, false);
}

export function BeaconReportCreatedWebhookFromJSONTyped(json: any, ignoreDiscriminator: boolean): BeaconReportCreatedWebhook {
    if (json == null) {
        return json;
    }
    return {
...
export function BeaconReportCreatedWebhookToJSON(value?: BeaconReportCreatedWebhook | null): any {
    if (value == null) {
        return value;
    }
    return {
