...
/**
 * Check if a given object implements the PaymentInitiationPaymentGetResponse interface.
 */
export function instanceOfPaymentInitiationPaymentGetResponse(value: object): boolean {
...
export function PaymentInitiationPaymentGetResponseFromJSON(json: any): PaymentInitiationPaymentGetResponse {
    return PaymentInitiationPaymentGetResponseFromJSONTyped(json, false);
}

export function PaymentInitiationPaymentGetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PaymentInitiationPaymentGetResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PaymentInitiationPaymentGetResponseToJSON(value?: PaymentInitiationPaymentGetResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
