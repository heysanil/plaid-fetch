...
/**
 * Check if a given object implements the WalletGetResponse interface.
 */
export function instanceOfWalletGetResponse(value: object): boolean {
...
export function WalletGetResponseFromJSON(json: any): WalletGetResponse {
    return WalletGetResponseFromJSONTyped(json, false);
}

export function WalletGetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WalletGetResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function WalletGetResponseToJSON(value?: WalletGetResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
