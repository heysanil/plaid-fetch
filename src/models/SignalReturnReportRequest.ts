...
/**
 * Check if a given object implements the SignalReturnReportRequest interface.
 */
export function instanceOfSignalReturnReportRequest(value: object): boolean {
    if (!('client_transaction_id' in value)) return false;
    if (!('return_code' in value)) return false;
    return true;
}

export function SignalReturnReportRequestFromJSON(json: any): SignalReturnReportRequest {
    return SignalReturnReportRequestFromJSONTyped(json, false);
}

export function SignalReturnReportRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SignalReturnReportRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function SignalReturnReportRequestToJSON(value?: SignalReturnReportRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
