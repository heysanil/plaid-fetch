 ...
 * @export
 */
export const AccountIdentityVerificationStatusEnum = {
...
export type AccountIdentityVerificationStatusEnum = typeof AccountIdentityVerificationStatusEnum[keyof typeof AccountIdentityVerificationStatusEnum];
...
export function AccountIdentityFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountIdentity {
    ...
    return {
        ...
        'documents': json['documents'] == null ? undefined : ((json['documents'] as Array<any>).map(IdentityDocumentFromJSON)),
    };
}
...
export function AccountIdentityToJSON(value?: AccountIdentity | null): any {
    ...
    return {
        ...
        'documents': value['documents'] == null ? undefined : ((value['documents'] as Array<any>).map(IdentityDocumentToJSON)),
    };
}
