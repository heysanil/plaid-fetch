...
/**
 * Check if a given object implements the TransactionsRecurringUpdateResponse interface.
 */
export function instanceOfTransactionsRecurringUpdateResponse(value: object): boolean {
    if (!('modified_streams' in value)) return false;
    return true;
}

export function TransactionsRecurringUpdateResponseFromJSON(json: any): TransactionsRecurringUpdateResponse {
    return TransactionsRecurringUpdateResponseFromJSONTyped(json, false);
}

export function TransactionsRecurringUpdateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionsRecurringUpdateResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function TransactionsRecurringUpdateResponseToJSON(value?: TransactionsRecurringUpdateResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
