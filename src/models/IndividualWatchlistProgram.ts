...
/**
 * Check if a given object implements the IndividualWatchlistProgram interface.
 */
export function instanceOfIndividualWatchlistProgram(value: object): boolean {
...
export function IndividualWatchlistProgramFromJSON(json: any): IndividualWatchlistProgram {
    return IndividualWatchlistProgramFromJSONTyped(json, false);
}

export function IndividualWatchlistProgramFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndividualWatchlistProgram {
    if (json == null) {
        return json;
    }
    return {
...
export function IndividualWatchlistProgramToJSON(value?: IndividualWatchlistProgram | null): any {
    if (value == null) {
        return value;
    }
    return {
