...
/**
 * Check if a given object implements the TransferSweep interface.
 */
export function instanceOfTransferSweep(value: object): boolean {
...
export function TransferSweepFromJSON(json: any): TransferSweep {
    return TransferSweepFromJSONTyped(json, false);
}

export function TransferSweepFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransferSweep {
    if (json == null) {
        return json;
    }
    return {
...
export function TransferSweepToJSON(value?: TransferSweep | null): any {
    if (value == null) {
        return value;
    }
    return {
