...
/**
 * Check if a given object implements the RecurringTransferNullable interface.
 */
export function instanceOfRecurringTransferNullable(value: object): boolean {
...
export function RecurringTransferNullableFromJSON(json: any): RecurringTransferNullable {
    return RecurringTransferNullableFromJSONTyped(json, false);
}

export function RecurringTransferNullableFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecurringTransferNullable {
    if (json == null) {
        return json;
    }
    return {
...
export function RecurringTransferNullableToJSON(value?: RecurringTransferNullable | null): any {
    if (value == null) {
        return value;
    }
    return {
